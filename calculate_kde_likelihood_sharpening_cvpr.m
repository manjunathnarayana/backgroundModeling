function [liks sigma_image sigmas] = calculate_kde_likelihood_sharpening_cvpr( pixel_samples, model, indicator, sigma_XYs, sigma_Ys, sigma_UVs, neighborhood_rows, neighborhood_cols, uniform_factor, num_vals, debug_flag)
%function [liks sigma_image sigmas] = calculate_kde_likelihood_sharpening_cvpr( pixel_samples, model, indicator, sigma_XYs, sigma_Ys, sigma_UVs, neighborhood_rows, neighborhood_cols, uniform_factor, num_vals, debug_flag)
