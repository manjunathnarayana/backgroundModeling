function [bg_mask fg_mask] = classify_using_kde_sharpening_sigma( img_pixels, bg_model, bg_indicator, bg_sigmas, bg_prior, bg_near_rows, bg_near_cols, fg_model, fg_indicator, fg_sigmas, fg_prior, fg_near_rows, fg_near_cols, fg_uniform_factor, num_feature_vals, debug_flag)
%function [bg_mask fg_mask] = classify_using_kde_sharpening_sigma( img_pixels, bg_model, bg_indicator, bg_sigmas, bg_prior, bg_near_rows, bg_near_cols, fg_model, fg_indicator, fg_sigmas, fg_prior, fg_near_rows, fg_near_cols, fg_uniform_factor, num_feature_vals, debug_flag)
%This is CVPR 2012 (Narayana et. al) code, but the normalization is as described in BMVC 2012. 
...
for res=1:num_resolutions
    ...
    [fg_liks{res} fg_sigmas_image{res} fg_model_sigmas{res}] = calculate_kde_likelihood_sharpening( img_pixels{res}, fg_model{res}, fg_indicator{res}, fg_sigma_XYs{res}, fg_sigma_Ys{res}, fg_sigma_UVs{res}, fg_near_rows, fg_near_cols, fg_uniform_factor, num_feature_vals, debug_flag);
end
