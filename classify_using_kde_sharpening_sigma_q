function [bg_mask fg_mask obj_mask bg_sigmas_image fg_sigmas_image obj_sigma_image] = classify_using_kde_sharpening_sigma_with_cache( img_pixels, bg_model, bg_indicator, bg_sigmas, bg_prior, prev_bg_sigma_images, bg_near_rows, bg_near_cols, fg_model, fg_indicator, fg_sigmas, fg_prior, prev_fg_sigma_images, fg_near_rows, fg_near_cols, fg_uniform_factor, objects, object_sigmas, object_sigma_images, object_near_rows, object_near_cols, search_window, num_feature_vals, tracking_version, debug_flag)
%function [bg_mask fg_mask obj_mask bg_sigma_image fg_sigma_image obj_sigma_image] = classify_using_kde_sharpening_sigma_with_cache( img_pixels, bg_model, bg_indicator, bg_sigmas, bg_prior, prev_bg_sigma_images, bg_near_rows, bg_near_cols, fg_model, fg_indicator, fg_sigmas, fg_prior, prev_fg_sigma_images, fg_near_rows, fg_near_cols, fg_uniform_factor, objects, object_sigmas, object_sigma_images, object_near_rows, object_near_cols, search_window, num_feature_vals, tracking_version, debug_flag)
