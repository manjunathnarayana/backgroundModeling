...
for res=1:num_resolutions
    ...
    fprintf('Computing sharpening match on %.0f percent of pixels (resolution %d of %d). Others set to cached values from prev frame\n', 100-(num_selected_pixels*100/num_res_rows/num_res_cols), res, num_resolutions );
